...
const Register = ({ showRegister, onClose }) => {
	...
	return (
		<DialogBox size="sm" dialog={showRegister} handleClose={onClose}>
			<DialogHeader>
				<h2 className="text-3xl text-center">Sign Up</h2>
				<p className="text-sm sm:w-3/4 mx-auto text-center">Learn on your own time from top universities and businesses.</p>
			</DialogHeader>
			<DialogBody>
				<div>
