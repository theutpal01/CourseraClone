...
const Hero = () => {
	return (
		<>
			<div className="px-5 lg:px-16 xl:px-28 w-full py-20 flex flex-col md:flex-row gap-10 md:gap-24 items-center justify-between">
				<div className="flex flex-col gap-8 w-full md:w-3/4 lg:w-3/5 mb-8 lg:mb-0">
					<h1 className="text-4xl md:text-6xl lg:text-8xl mb-6 lg:mb-8 text-black font-semibold">
			...
			<div className="w-full bg-gray-200 py-16 text-center flex flex-col gap-14 px-5 lg:px-16 xl:px-28">
				...
				<div className="flex gap-6 justify-center items-center flex-wrap">
					<img src={CompanyLogo1} alt="Company" className="max-w-[150px] h-auto" />
					<img src={CompanyLogo2} alt="Company" className="max-w-[150px] h-auto" />
					<img src={CompanyLogo3} alt="Company" className="max-w-[150px] h-auto" />
					<img src={CompanyLogo4} alt="Company" className="max-w-[150px] h-auto" />
					<img src={CompanyLogo5} alt="Company" className="max-w-[150px] h-auto" />
					<img src={CompanyLogo6} alt="Company" className="max-w-[150px] h-auto" />
					<img src={CompanyLogo7} alt="Company" className="max-w-[150px] h-auto" />
					<img src={CompanyLogo8} alt="Company" className="max-w-[150px] h-auto" />
				</div>
			</div>
		</>
	);
