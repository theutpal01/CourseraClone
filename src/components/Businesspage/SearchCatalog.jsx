...
const SearchCatalog = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-blue-50 p-8 sm:h-[40vh] h-auto">
      {/* Heading */}
      ...
      <div className="mt-4 flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
        <p className="text-gray-600 font-semibold text-center sm:text-left">Popular</p>
        <div className="flex flex-wrap gap-2 justify-center sm:justify-start">
          {["Business", "Computer Science", "Data Science", "Information Technology", "Health", "Arts and Humanities"].map((tag) => (
            <a 
              key={tag}
