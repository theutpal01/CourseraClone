...
const CallToAction = () => (
	<div className="flex justify-center py-8 px-4 sm:px-6 lg:px-8">
		<div
			className="bg-black text-white py-8 px-4 rounded-lg shadow-lg w-full max-w-md sm:max-w-lg lg:max-w-screen-lg text-center"
			style={{ minHeight: "50vh", margin: "0 2rem" }}
		>
			<h2 className="text-3xl sm:text-4xl md:text-5xl font-medium mb-4">
				Find a plan that's right for you
			</h2>
			<p className="text-lg sm:text-xl mb-6">
				Connect with our team to learn how you can prepare your business for
				rapid change.
			</p>
			...
			<p className="text-gray-400 text-xs sm:text-sm">
				...
				<a href="/coursera-teams" className="text-blue-500 underline">
	...
	<div className="py-10 mt-4 px-4 sm:px-6 lg:px-8">
		<div className="max-w-screen-lg mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
			{infoCards.map((card, index) => (
				<div
					key={index}
					className="bg-blue-800 text-white p-6 rounded-lg shadow-md"
				>
