...
import generativeai from "../../assets/business/generativeai.png";
import techAcademyImage from "../../assets/business/Tech-academy.png";
import dataAnalyticsImage from "../../assets/business/data-analytics.png";
import leadershipImage from "../../assets/business/leadership.png";
import marketingImage from "../../assets/business/marketing-academy.png";
import financeImage from "../../assets/business/finance.png";
import digitalMarketingImage from "../../assets/business/career.png";

const programs = [
	{
		title: "Generative AI Academy",
		description:
			"Improve productivity, reduce risks, and stay current with the latest in generative AI. Courses range from beginner to advanced, taught by leading experts.",
...
const Carousel = () => {
	...
	return (
		<div className="bg-blue-700 px-5 py-10 lg:px-16 xl:px-28 relative min-h-[70vh]">
			<div className="max-w-screen-lg mx-auto">
				<h2 className="text-white text-sm font-bold">SKILLS FOR JOB ROLES</h2>
				<br />
				<h1 className="text-white text-4xl font-semibold mt-2">
					Strengthen workplace skills with customized learning pathways
				</h1>
				<p className="text-white mt-4 text-lg">
					Discover learning pathways and credentials designed to build
					high-impact skills that support your
					<br /> company's strategic priorities.
				</p>
				...
				<div className="relative mt-5">
							...
							{displayedPrograms.map((program, index) => (
								...
								>
									...
									<div className="p-4 flex flex-col flex-grow">
										<h3 className="text-md font-semibold text-black overflow-hidden text-ellipsis">
											{program.title}
										</h3>
										<p className="text-sm text-gray-600 mt-1 flex-grow overflow-hidden text-ellipsis">
											{program.description}
										</p>
										<div className="text-sm text-black mt-1 flex items-center">
											<span className="text-yellow-500">★</span>
											<span className="ml-2">
												{program.rating.split(" ")[0]}
											</span>
											<span className="text-gray-600 ml-1">
												({program.rating.split(" ").slice(1).join(" ")})
											</span>
										</div>
										<span className="text-sm text-blue-500 mt-1 inline-block">
											Learn more →
										</span>
									</div>
								</div>
					...
					<div className="absolute top-[-40px] right-2 flex space-x-4 z-10">
						...
						<span
							onClick={nextSlide}
							className={`cursor-pointer text-white text-xl ${
								currentIndex === totalSlides - 1 ? "opacity-50" : ""
							}`}
						>
							→
						</span>
