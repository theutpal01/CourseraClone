...
function Footer({ childContact }) {
    return (
        <footer className="p-4 sm:p-8 text-center text-sm md:text-base">
            <hr className="m-2 sm:m-4"/>
            <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 mb-4 sm:mb-8 text-black">

                {/* Coursera Column */}
                <div className="text-left">
                    <h2 className="font-semibold text-base sm:text-lg mb-2 sm:mb-4">Coursera</h2>
                ...
                {/* Community Column */}
                <div className="text-left">
                    <h2 className="font-semibold text-base sm:text-lg mb-2 sm:mb-4">Community</h2>
                    <ul className="space-y-1 sm:space-y-2 text-gray-600">
                ...
                {/* More Column */}
                <div className="text-left">
                    <h2 className="font-semibold text-base sm:text-lg mb-2 sm:mb-4">More</h2>
                    <ul className="space-y-1 sm:space-y-2 text-gray-600">
                ...
                {/* Mobile App Column */}
                <div className="text-center sm:text-left sm:col-span-2 md:col-span-1 mx-auto">
                    <h2 className="font-semibold text-base sm:text-lg mb-2 sm:mb-4">Mobile App</h2>
                    <ul className="space-y-4 sm:space-y-8 text-gray-600">
                        <li><a href="https://apps.apple.com/us/app/coursera-grow-your-career/id736535961" target='_blank'><img src={AppStore} alt="" className="rounded-lg h-12 sm:h-auto w-32 sm:w-48 mx-auto sm:mx-0"/></a></li>
                        <li><a href="https://play.google.com/store/apps/details?id=org.coursera.android&hl=en" target='_blank'><img src={PlayStore} alt="" className="rounded-lg h-12 sm:h-auto w-32 sm:w-48 mx-auto sm:mx-0"/></a></li>
                    </ul>
                </div>
            </div>
